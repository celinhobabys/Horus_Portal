...
class QWERTYKeyboard:
    ...
    def highlight_key(self, label):
        ...
        if label.upper() in self.key_mappings:
            label = self.key_mappings[label.upper()]
        else:
            label = label.upper()
    ...
    def unbind_keys(self):
        ...
        self.root.unbind("<Control-KeyPress>")
        self.root.unbind("<Alt-KeyPress>")
        self.root.unbind("<Shift-KeyPress>")
        self.root.unbind("<Control-KeyRelease>")
        self.root.unbind("<Alt-KeyRelease>")
        self.root.unbind("<Shift-KeyRelease>")
    ...
    def register_action(self, label, mode):
        ...
        if label.upper() in self.key_mappings and self.key_mappings[label.upper()] in self.special_keys:
            formatted = ""
